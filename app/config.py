...
LANGUAGE_DETECTOR_MODEL = os.getenv(
    "LANGUAGE_DETECTOR_MODEL", "gemini-3-pro-preview"
)

# Code analysis is mechanical - use faster, cheaper model
CODE_ANALYZER_MODEL = os.getenv("CODE_ANALYZER_MODEL", "gemini-2.5-flash")
...
FEEDBACK_SYNTHESIZER_MODEL = os.getenv(
    "FEEDBACK_SYNTHESIZER_MODEL", "gemini-2.5-pro"
)
...
PYTHON_STYLE_IGNORE = os.getenv(
    "PYTHON_STYLE_IGNORE", "E501,W503"
).split(",")  # Line length, line break before binary operator
TYPESCRIPT_STYLE_CONFIG = os.getenv(
    "TYPESCRIPT_STYLE_CONFIG", ".eslintrc.json"
)
